...
class SuccessfullyRentedConstructionEquipment extends Model
{
    use HasFactory;

    protected $table = 'successfully_rented_construction_equipments';
    ...
    {
        return $this->belongsTo(ConstructionEquipmentOrderMatch::class);
    }
